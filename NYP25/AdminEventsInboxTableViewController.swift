//
//  AdminEventsInboxTableViewController.swift
//  NYP25
//
...
class AdminEventsInboxTableViewController: UITableViewController {
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "ShowImageDetails"{
            ...
            if indexPath != nil{
                vc.currentPhoto = flaggedPhotoList[(indexPath?.row)!]
            }
