//
//  UserProfileCommentsForLikedPhotosTableViewController.swift
//  NYP25
//
...
class UserProfileCommentsForLikedPhotosTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "commentCells", for: indexPath)
            as! UserProfileCommentsForLikedPhotosTableViewCell
