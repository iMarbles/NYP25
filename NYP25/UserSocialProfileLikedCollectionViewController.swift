...
private let reuseIdentifier = "ProfilePageLikedCell"
...
class UserSocialProfileLikedCollectionViewController: UICollectionViewController , UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ProfilePageLikedCell", for: indexPath) as! UserSocialProfileLikedCollectionViewCell
